...
class ProvisionNewMachineWithCredInputScreen extends StatefulWidget {
  ...
  @override
  State<ProvisionNewMachineWithCredInputScreen> createState() => _ProvisionNewMachineWithCredInputScreenState();
}

class _ProvisionNewMachineWithCredInputScreenState extends State<ProvisionNewMachineWithCredInputScreen> {
  String? _robotName;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Theme.of(context).colorScheme.surface,
        title: Text('Provision New Machine (With Credential Input)', style: TextStyle(color: Theme.of(context).colorScheme.onSurface)),
      ),
      body: Center(
        child: Column(
